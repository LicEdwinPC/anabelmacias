										...
										<div class="d-flex align-items-center">
											...
											<select class="form-control" id="kt_datatable_search_type">
												...
												foreach ($tipo_platillo as $key => $row) {
													?>
													<option value="<?php echo isset($row->descripcion) ? strtoupper($row->descripcion) :"";?>"><?php echo isset($row->descripcion) ? strtoupper($row->descripcion) : "S/D";?></option>
													<?php
												}
												?>
					...
					<table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable2">
						<thead>
							<tr>
								...
								<th title="Tipo de platillo">Tipo de platillo</th>
						...
						<?php 
							foreach ($pedidos as $key => $pedido) {
								...
								<tr>
									...
									<td><?php echo isset($pedido->TipoPlatillo)? strtoupper($pedido->TipoPlatillo): "S/D";?></td>
									<td><?php echo isset($pedido->FPedido)? utils::fecha($pedido->FPedido): "S/D";?></td>
