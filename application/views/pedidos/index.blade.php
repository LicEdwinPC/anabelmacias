...
<div class="card card-custom">
	<div class="card-header">
		<div class="card-title">
			...
			<h2>Menu del Lunes 17 de Abril - Viernes 21 de Abril</h2>
		</div>
	</div>
	<div class="card-body">
		<div class="row my-10">
			<!--begin: Lunes-->
			<div class="col-md-6 col-xxl-2 offset-1 border-right-0 border-right-md border-bottom border-bottom-xxl-0  text-center">
				<div class="pt-30 pt-md-25 pb-15 px-5 ">
					...
					<span class="font-size-h1 d-block font-weight-boldest text-dark-75 py-2">Lunes</span><hr>
					<p class="mb-5 d-flex flex-column">
					<h4 class="font-size-h6 d-block font-weight-bold mb-7 text-dark-50"> <input type="checkbox" name="" id=""> Comida</h4>
					<h4 class="font-size-h6 d-block font-weight-bold mb-7 text-dark-50"><input type="checkbox" name="" id=""> Postre</h4>
					</p>
			...
			<div class="col-md-6 col-xxl-2 border-right-0 border-right-md border-bottom border-bottom-xxl-0  text-center">
				<div class="pt-30 pt-md-25 pb-15 px-5 ">
					<div class="d-flex flex-center position-relative mb-25">
						...
						<span class="svg-icon svg-icon-success svg-icon-5x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo8/dist/../src/media/svg/icons/Cooking/KnifeAndFork2.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
							<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
								<rect x="0" y="0" width="24" height="24"/>
								<path d="M3.98842709,3.05999994 L11.0594949,10.1310678 L8.23106778,12.9594949 L3.98842709,8.71685419 C2.42632992,7.15475703 2.42632992,4.62209711 3.98842709,3.05999994 Z" fill="#000000"/>
								<path d="M17.7539614,3.90710683 L14.8885998,7.40921548 C14.7088587,7.62889898 14.7248259,7.94903916 14.9255342,8.14974752 C15.1262426,8.35045587 15.4463828,8.36642306 15.6660663,8.18668201 L19.1681749,5.32132039 L19.8752817,6.02842717 L17.0099201,9.53053582 C16.830179,9.75021933 16.8461462,10.0703595 17.0468546,10.2710679 C17.2475629,10.4717762 17.5677031,10.4877434 17.7873866,10.3080024 L21.2894953,7.44264073 L21.9966021,8.14974752 L18.8146215,11.331728 C17.4477865,12.6985631 15.2317091,12.6985631 13.8648741,11.331728 C12.4980391,9.96489301 12.4980391,7.74881558 13.8648741,6.38198056 L17.0468546,3.20000005 L17.7539614,3.90710683 Z" fill="#000000"/>
					...
					<span class="font-size-h1 d-block font-weight-boldest text-dark-75 py-2 text-center">Martes</span><hr>
					<p class="mb-5 d-flex flex-column">
					<h4 class="font-size-h6 d-block font-weight-bold mb-7 text-dark-50"> <input type="checkbox" name="" id=""> Comida</h4>
					<h4 class="font-size-h6 d-block font-weight-bold mb-7 text-dark-50"><input type="checkbox" name="" id=""> Postre</h4>
					</p>
					...
					<div class="d-flex justify-content-center pt-5">
						<button type="button" class="btn btn-success text-uppercase font-weight-bolder px-15 py-3">Enviar</button>
					</div>
				</div>
			</div>
			<!--end: martes-->
			...
			<div class="col-md-6 col-xxl-2 border-right-0 border-right-md border-bottom border-bottom-xxl-0  text-center">
				<div class="pt-30 pt-md-25 pb-15 px-5 ">
					<div class="d-flex flex-center position-relative mb-25">
						...
						<span class="svg-icon svg-icon-danger svg-icon-5x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo8/dist/../src/media/svg/icons/Cooking/KnifeAndFork2.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
							<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
								<rect x="0" y="0" width="24" height="24"/>
								<path d="M3.98842709,3.05999994 L11.0594949,10.1310678 L8.23106778,12.9594949 L3.98842709,8.71685419 C2.42632992,7.15475703 2.42632992,4.62209711 3.98842709,3.05999994 Z" fill="#000000"/>
								<path d="M17.7539614,3.90710683 L14.8885998,7.40921548 C14.7088587,7.62889898 14.7248259,7.94903916 14.9255342,8.14974752 C15.1262426,8.35045587 15.4463828,8.36642306 15.6660663,8.18668201 L19.1681749,5.32132039 L19.8752817,6.02842717 L17.0099201,9.53053582 C16.830179,9.75021933 16.8461462,10.0703595 17.0468546,10.2710679 C17.2475629,10.4717762 17.5677031,10.4877434 17.7873866,10.3080024 L21.2894953,7.44264073 L21.9966021,8.14974752 L18.8146215,11.331728 C17.4477865,12.6985631 15.2317091,12.6985631 13.8648741,11.331728 C12.4980391,9.96489301 12.4980391,7.74881558 13.8648741,6.38198056 L17.0468546,3.20000005 L17.7539614,3.90710683 Z" fill="#000000"/>
					...
					<span class="font-size-h1 d-block font-weight-boldest text-dark-75 py-2 text-center">Miércoles</span><hr>
					<p class="mb-5 d-flex flex-column">
					<h4 class="font-size-h6 d-block font-weight-bold mb-7 text-dark-50"> <input type="checkbox" name="" id=""> Comida</h4>
					<h4 class="font-size-h6 d-block font-weight-bold mb-7 text-dark-50"><input type="checkbox" name="" id=""> Postre</h4>
					</p>
					...
					<div class="d-flex justify-content-center pt-5">
						<button type="button" class="btn btn-danger text-uppercase font-weight-bolder px-15 py-3">Enviar</button>
					</div>
				</div>
			</div>
			<!--end: Pricing-->
			...
			<div class="col-md-6 col-xxl-2 border-right-0 border-right-md border-bottom border-bottom-xxl-0  text-center">
				<div class="pt-30 pt-md-25 pb-15 px-5 ">
					<div class="d-flex flex-center position-relative mb-25">
						...
						<span class="svg-icon svg-icon-warning svg-icon-5x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo8/dist/../src/media/svg/icons/Cooking/KnifeAndFork2.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
							<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
								<rect x="0" y="0" width="24" height="24"/>
								<path d="M3.98842709,3.05999994 L11.0594949,10.1310678 L8.23106778,12.9594949 L3.98842709,8.71685419 C2.42632992,7.15475703 2.42632992,4.62209711 3.98842709,3.05999994 Z" fill="#000000"/>
								<path d="M17.7539614,3.90710683 L14.8885998,7.40921548 C14.7088587,7.62889898 14.7248259,7.94903916 14.9255342,8.14974752 C15.1262426,8.35045587 15.4463828,8.36642306 15.6660663,8.18668201 L19.1681749,5.32132039 L19.8752817,6.02842717 L17.0099201,9.53053582 C16.830179,9.75021933 16.8461462,10.0703595 17.0468546,10.2710679 C17.2475629,10.4717762 17.5677031,10.4877434 17.7873866,10.3080024 L21.2894953,7.44264073 L21.9966021,8.14974752 L18.8146215,11.331728 C17.4477865,12.6985631 15.2317091,12.6985631 13.8648741,11.331728 C12.4980391,9.96489301 12.4980391,7.74881558 13.8648741,6.38198056 L17.0468546,3.20000005 L17.7539614,3.90710683 Z" fill="#000000"/>
					...
					<span class="font-size-h1 d-block font-weight-boldest text-dark-75 py-2 text-center">Jueves</span><hr>
					<p class="mb-5 d-flex flex-column">
					<h4 class="font-size-h6 d-block font-weight-bold mb-7 text-dark-50"> <input type="checkbox" name="" id=""> Comida</h4>
					<h4 class="font-size-h6 d-block font-weight-bold mb-7 text-dark-50"><input type="checkbox" name="" id=""> Postre</h4>
					</p>
					...
					<div class="d-flex justify-content-center pt-5">
						<button type="button" class="btn btn-warning text-uppercase font-weight-bolder px-15 py-3">Enviar</button>
					</div>
				</div>
			</div>
			<!--end: Pricing-->
			...
			<div class="col-md-6 col-xxl-2 border-right-0 border-right-md border-bottom border-bottom-xxl-0  text-center">
				<div class="pt-30 pt-md-25 pb-15 px-5 ">
					...
					<span class="font-size-h1 d-block font-weight-boldest text-dark-75 py-2 text-center">Viernes</span><hr>
					<p class="mb-5 d-flex flex-column">
					<h4 class="font-size-h6 d-block font-weight-bold mb-7 text-dark-50"> <input type="checkbox" name="" id=""> Comida</h4>
					<h4 class="font-size-h6 d-block font-weight-bold mb-7 text-dark-50"><input type="checkbox" name="" id=""> Postre</h4>
					</p>
					...
					<div class="d-flex justify-content-center pt-5">
						<button type="button" class="btn btn-primary text-uppercase font-weight-bolder px-15 py-3">Enviar</button>
					</div>
				</div>
			</div>
			<!--end: Pricing-->
