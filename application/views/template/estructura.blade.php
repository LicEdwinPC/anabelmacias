...
<head>
    ...
    <link href="<?php echo THEME_URL.'dist/assets/plugins/global/plugins.bundle.css'?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo THEME_URL.'dist/assets/plugins/custom/prismjs/prismjs.bundle.css';?>" rel="stylesheet" type="text/css" />
    ...
    <!--end::Layout Themes-->
    <link rel="shortcut icon" href="<?php echo THEME_URL.'assets/Theme/src/media/logos/favicon.ico';?>" /> @yield('css')
</head>
<!--end::Head-->
<!--begin::Body-->
...
<body id="kt_body" class="header-fixed header-mobile-fixed header-bottom-enabled subheader-enabled page-loading">
    ...
    <div id="kt_header_mobile" class="header-mobile bg-primary header-mobile-fixed">
        <!--begin::Logo-->
        <a href="index.html">
				<img alt="Logo" src="<?php echo THEME_URL.'assets/media/logos/logo-gob.png';?>" class="max-h-30px" />
			</a>
        <!--end::Logo-->
        <!--begin::Toolbar-->
                        ...
                        <div class="container">
                            ...
                            <div class="d-none d-lg-flex align-items-center mr-3">
                                ...
                                <a href="index.html" class="mr-20">
										<img alt="Logo" src="<?php echo THEME_URL.'dist/assets/media/logos/logo-gob.png';?>" class="max-h-70px" />
									</a>
                                <!--end::Logo-->
                                ...
                                <ul class="header-tabs nav align-self-end font-size-lg" role="tablist">
                                    ...
                                    <li class="nav-item mr-3">
                                        <a href="#" class="nav-link py-4 px-6" data-toggle="tab" data-target="#kt_header_tab_2" role="tab">Usuarios</a>
                                    </li>
                                    <!--end::Item-->
                                    <!--begin::Item-->
                                    <li class="nav-item mr-3">
                                        <a href="#" class="nav-link py-4 px-6" data-toggle="tab" data-target="#kt_header_tab_2" role="tab">Contratos</a>
                                    </li>
                                    <!--end::Item-->
                                    <!--begin::Item-->
                                    <li class="nav-item mr-3">
                                        <a href="#" class="nav-link py-4 px-6" data-toggle="tab" data-target="#kt_header_tab_2" role="tab">Contacto</a>
                                    </li>
                                    <!--end::Item-->
                                </ul>
                                <!--begin::Tab Navs-->
                    ...
                    <div class="subheader py-2 py-lg-4 subheader-transparent" id="kt_subheader">
                        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <!--end::Button-->
                                <!--begin::Button-->
                                <a href="custom/apps/user/add-user.html" class="btn btn-light-primary font-weight-bold btn-sm px-4 font-size-base ml-2">Agregar Usuario</a>
                                <!--end::Button-->
                                ...
                                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                                    <div class="card-title">
                                        <h3 class="card-label">
                                            ...
                                            <span class="d-block text-muted pt-2 font-size-sm"><?php echo isset($description) ? $description : "S/D";?></span>
                                        </h3>
                                    </div>
                ...
                <div class="footer bg-white py-4 d-flex flex-lg-column" style="border-top: 2px solid #612233;" id="kt_footer">
                    ...
                    <div class="container d-flex flex-column flex-md-row align-items-center justify-content-between">
                        ...
                        <div class="nav nav-dark order-1 order-md-3">
                            <a href="http://keenthemes.com/metronic" target="_blank" class="nav-link pr-3 pl-0">Acerca de</a>
                            <a href="http://keenthemes.com/metronic" target="_blank" class="nav-link px-3">Servicio al cliente</a>
                            <a href="http://keenthemes.com/metronic" target="_blank" class="nav-link pl-3 pr-0">Contacto</a>
                        </div>
                        <!--end::Nav-->
                    </div>
                    <!--end::Container-->
        ...
        <div class="offcanvas-content pr-5 mr-n5">
            ...
            <div class="d-flex align-items-center mt-5">
                <div class="symbol symbol-100 mr-5">
                    <div class="symbol-label" style="background-image:url('<?php echo THEME_URL.'dist/assets/media/users/300_21.jpg';?>)"></div>
