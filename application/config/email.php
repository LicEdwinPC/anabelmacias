...
$config['mailpath']         = '';
$config['smtp_host']        = 'p3plcpnl0504.prod.phx3.secureserver.net';
$config['smtp_user']        = 'buzon.icm@icmujeres.org';
$config['smtp_pass']        = 'Instituto#2020';
$config['smtp_port']        = 465;                      // 465 - ssl 587- tls
...
$config['charset']          = '';                     // 'UTF-8', 'ISO-8859-15', ...; NULL (preferable) means config_item('charset'), i.e. the character set of the site.
$config['validate']         = true;
$config['priority']         = 5;                        // 1, 2, 3, 4, 5; on PHPMailer useragent NULL is a possible option, it means that X-priority header is not set at all, see https://github.com/PHPMailer/PHPMailer/issues/449
$config['crlf']             = "\n";                     // "\r\n" or "\n" or "\r"
$config['newline']          = "\n";                     // "\r\n" or "\n" or "\r"
